...
if strcmpi( unitary,'y') 
    ...
    U=input(prompt);function finalMatrix = pud(matrixGiven, permutation)
...
N=2^n;
d=N*(N-1)/2;
V=zeros(d,4);function finalMatrix = pud(matrixGiven, permutation)
...
controls=0;
num=d;
for j=1:dfunction finalMatrix = pud(matrixGiven, permutation)
