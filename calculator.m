...
% Last Modified by GUIDE v2.5 22-May-2020 03:12:10
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.input,'string',num2str(0));
global input;
global output;
output = input+output;
...
set(handles.answer, 'String', num2str(output));

% --- Executes on key press with focus on plus and none of its controls.
function plus_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to plus (see GCBO)
